...
class NGAPI
{
	...
	public static inline var APPID:String = "57063:jthmKHYR";
	public static inline var ENCKEY:String = "CEsWqUVjeKyYvZsBZE8gLg==";
	...
	public static var medalsLodads(default, null):Bool = false;
...
{
	var VIEW = "View";
	var BEAT_CITY = "Beat City Level";
	var BEAT_FOREST = "Beat Forest Level";
